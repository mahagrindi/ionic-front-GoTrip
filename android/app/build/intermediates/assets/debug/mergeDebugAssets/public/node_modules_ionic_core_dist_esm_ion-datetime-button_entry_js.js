...
const DatetimeButton = class {
  constructor(hostRef) {
    ...
    this.setDateTimeText = () => {
      ...
      const use24Hour = (0,_parse_71f28cd7_js__WEBPACK_IMPORTED_MODULE_6__.I)(locale, hourCycle);
     ...
     */
    this.waitForDatetimeChanges = /*#__PURE__*/(0,C_Users_yosra_OneDrive_Bureau_dmwm_2_projet_I_projet_sem_1_projet_DMWM_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const {
        datetimeEl
      } = _this;
      if (!datetimeEl) {
    ...
    this.handleDateClick = /*#__PURE__*/function () {
      var _ref2 = (0,C_Users_yosra_OneDrive_Bureau_dmwm_2_projet_I_projet_sem_1_projet_DMWM_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (ev) {
        const {
          datetimeEl,
          datetimePresentation
        } = _this;
    ...
    this.presentOverlay = /*#__PURE__*/function () {
      var _ref3 = (0,C_Users_yosra_OneDrive_Bureau_dmwm_2_projet_I_projet_sem_1_projet_DMWM_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (ev, needsPresentationChange, triggerEl) {
        const {
          overlayEl
        } = _this;
        if (!overlayEl) {
