...
entry5:any;
  ...
  ngOnInit() {}
  interpress() {this.entry =  !this.entry;}
  interpress1(){this.entry1= !this.entry1;}
  interpress2(){this.entry2= !this.entry2;}
  interpress3(){this.entry3= !this.entry3;}
  interpress4(){this.entry4= !this.entry4;}
  interpress5(){this.entry5= !this.entry5;}
  ...
  updateRecomended()
  {this.intrestsService.updateRecomemnd(this.createTableCategorie()).subscribe(res=>{this.route.navigate(['/tabs']);},err=>{console.log(err);})}
}
